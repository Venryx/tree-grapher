...
export declare function wrapFlexNode<T extends FlexNode, Datum = any>(FlexClass: new (..._: any[]) => T, treeData: Datum, children: ChildrenFunc<Datum>, nodeSize: NodeSizeFunc<Datum>, spacing: SpacingFunc<Datum>): T;
